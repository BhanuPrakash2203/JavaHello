...
{
    [TestClass]
    public class SommaireBonSuccessoralMapperTest
    {
        ...
        {
            var section = Auto.Create<SommaireBonSuccessoralModel>();
            ...
            var subject = new PageSommaireBonSuccessoralMapper(_autoMapperFactory);
