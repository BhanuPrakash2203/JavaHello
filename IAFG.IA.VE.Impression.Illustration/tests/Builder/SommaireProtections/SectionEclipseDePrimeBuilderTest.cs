...
{
    [TestClass]
    public class SectionEclipseDePrimeTest
    {
        ...
        public void Initialize()
        {
            ...
            _builder = new SectionDetailEclipseDePrimeBuilder(_reportFactory, new SectionDetailEclipseDePrimeMapper(_autoMapperFactory));
        }

        [TestMethod]
        public void Build_WhenBuildParameters_ShouldAssembleReportProperly()
        {
            var sectionModel = AutoFixture.Create<SectionDetailEclipseDePrimeModel>();
            ...
            _builder.Build(new BuildParameters<SectionDetailEclipseDePrimeModel>(sectionModel)
            {
