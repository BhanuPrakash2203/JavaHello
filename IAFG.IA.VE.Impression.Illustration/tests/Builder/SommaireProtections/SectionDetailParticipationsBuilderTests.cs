...
namespace IAFG.IA.VE.Impression.Illustration.Test.Builder.SommaireProtections
{
    ...
    public class SectionDetailParticipationsBuilderTests
    {
        ...
        public void Initialize()
        {
            ...
            _builder = new SectionDetailParticipationsBuilder(_reportFactory,
                new SectionDetailParticipationsMapper(_autoMapperFactory));
        }

        [TestMethod]
        public void Build_WhenBuidParameters_ShouldAssembleReportProperly()
        {
            var sectionModel = AutoFixture.Create<SectionDetailParticipationsModel>();
            ...
            _builder.Build(new BuildParameters<SectionDetailParticipationsModel>(sectionModel)
            {
