...
{
    [TestClass]
    public class SectionTableauDescriptionTest
    {
        ...
        private readonly ISectionTableau _report = Substitute.For<ISectionTableau>();
        ...
        [TestMethod]
        public void GIVEN_SectionTableauDescriptionBuilder_WHEN_Build_THEN_ShouldAddItselfToParentReport()
        {
            _reportFactory.Create<ISectionTableau>().Returns(_report);

            var builder = new SectionTableauBuilder(_reportFactory);
