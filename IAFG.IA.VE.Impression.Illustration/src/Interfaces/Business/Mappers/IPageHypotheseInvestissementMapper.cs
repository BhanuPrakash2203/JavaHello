...
{
    public interface IPageHypotheseInvestissementMapper : IReportMapperWithContext<SectionHypothesesInvestissementModel, PageHypotheseInvestissementViewModel>
    {
