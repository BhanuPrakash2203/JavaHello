...
namespace IAFG.IA.VE.Impression.Illustration.Interfaces.Business.Mappers.ModificationsDemandees
{
    public interface ISectionContratMapper : IReportMapperWithContext<SectionContratModel, ContratViewModel>
    {
