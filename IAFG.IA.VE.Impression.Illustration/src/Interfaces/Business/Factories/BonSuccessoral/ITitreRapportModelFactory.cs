...
{
    public interface ITitreRapportModelFactory : IFactoryBase<TitreRapportModel>
    {
        TitreRapportModel Build(string sectionId, DonneesRapportIllustration donnees, IReportContext context);
    }
}