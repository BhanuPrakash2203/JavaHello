...
{
    public interface IUsageAuConseillerModelBuilder
    {
        SectionUsageAuConseillerModel Build(DefinitionSection definition, DonneesRapportIllustration donnees, IReportContext context);
    }
}
