...
{
    public class PageResultatMapper : ReportMapperBase<SectionResultatModel, PageResultatViewModel>, IPageResultatMapper
    {
        public PageResultatMapper(IAutoMapperFactory autoMapperFactory) : base(autoMapperFactory)
        {
        }
        ...
        public class ReportProfile : ReportProfileBase
        {
            ...
            {
                CreateMap<SectionResultatModel, PageResultatViewModel>().
                    ...
                    ForMember(d => d.Tableaux, m => m.MapFrom(s => managerFactory.GetTableauResultatManager().MapperTableaux(s.Tableau, s)));
            }
        }       
    }
}