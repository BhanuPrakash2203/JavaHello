...
namespace IAFG.IA.VE.Impression.Illustration.Business.Builders.SommaireProtectionsIllustration
{
    public class SectionDetailEclipseDePrimeBuilder : ISectionDetailEclipseDePrimeBuilder
    {
        ...
        public SectionDetailEclipseDePrimeBuilder(IReportFactory reportFactory)
        {
            _reportFactory = reportFactory;
        }

        public void Build(BuildParameters<SectionDetailEclipseDePrimeViewModel> parameters)
        {
